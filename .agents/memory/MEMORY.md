...
- [Workflow scanner stale-path failure](workflow-scanner-stale-path.md) — managed workflow RPC may fail on a missing `.local/secondary_skills/.tmp-*` path even while the app itself runs normally
